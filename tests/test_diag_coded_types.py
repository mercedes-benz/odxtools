...
class TestLeadingLengthInfoType(unittest.TestCase):
    def test_decode_leading_length_info_type_bytefield(self):
        dct = LeadingLengthInfoType(base_data_type="A_BYTEFIELD",
                                    bit_length=6,
    ...
    def test_encode_leading_length_info_type_bytefield(self):
        dct = LeadingLengthInfoType(base_data_type="A_UTF8STRING",
                                    bit_length=6,
                                    base_type_encoding=None,
                                    is_highlow_byte_order_raw=None)
    ...
    def test_end_to_end(self):
        ...
        diagcodedtypes = {
            ...
            "certificateClient":
            LeadingLengthInfoType(base_data_type="A_BYTEFIELD",
                                  bit_length=8,
                                  base_type_encoding=None,
                                  is_highlow_byte_order_raw=None)
        }
        ...
        diag_layer = DiagLayer(
            ...
            positive_responses=[],
            negative_responses=[],
            diag_data_dictionary_spec=DiagDataDictionarySpec(data_object_props=dops.values(),
...
class TestStandardLengthType(unittest.TestCase):
    ...
    def test_decode_standard_length_type_bytes(self):
        dct = StandardLengthType(base_data_type="A_BYTEFIELD",
                                 base_type_encoding=None,
                                 bit_length=16,
                                 bit_mask=None,
                                 is_condensed_raw=None,
...
class TestMinMaxLengthType(unittest.TestCase):
    ...
    def test_encode_min_max_length_type_zero(self):
        dct = MinMaxLengthType(base_data_type="A_UTF8STRING",
                               base_type_encoding=None,
                               min_length=2,
                               max_length=4,
                               termination="ZERO",
