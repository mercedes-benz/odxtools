...
class utilFunctions():
    ...
    def list_arguments_and_execution(
            path_to_pdx_file = '.\examples\somersault.pdx',
            ecu_variants = "all",
    ...
    def find_arguments_and_execution(
            path_to_pdx_file = '.\examples\somersault.pdx',
            ecu_variants = "all",
            data = None,
            decode = None,
...
class TestCommandLineTools(unittest.TestCase):
    ...
    def test_browse_command(self):
        browse_args = Namespace(
            pdx_file='.\examples\somersault.pdx'
        )
