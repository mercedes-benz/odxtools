...
from .complexcomparamspec import ComplexComparamSpec, ComplexValue, create_complex_value_from_et
...
class Comparam:
    ...
    def _resolve_odxlinks(self, odxlinks: OdxLinkDatabase) -> None:
        self._spec = odxlinks.resolve(self.spec_ref, BaseComparamSpec)

    def _resolve_snrefs(self, diag_layer: "DiagLayer") -> None:
        pass

    @property
    def spec(self) -> BaseComparamSpec:
        return self._spec
    ...
    def get_value(self) -> Optional[str]:
        ...
        if not isinstance(self.spec, ComparamSpec):
            odxraise()
    ...
    def get_subvalue(self, subparam_name: str) -> Optional[str]:
        ...
        if not isinstance(comparam_spec, ComplexComparamSpec):
            odxraise()
